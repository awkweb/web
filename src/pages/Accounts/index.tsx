...
class AccountsPage extends React.Component<Props> {
  ...
  public render() {
    const {
      rootStore: {
        itemsStore: { items, isDeleting, isLoading, deleteItem, renewLink }
      }
    } = this.props;
          ...
          <Row>
            <Col xs={12}>
              ...
              >
                ...
                <Box>
                  <PlaidLink onLoad={this.onLoad} onSuccess={this.onSuccess}>
                    Add Account
                  </PlaidLink>
                </Box>
              </Box>
...
export const Accounts = inject("rootStore")(observer(AccountsPage));
