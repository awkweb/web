        ...
        <Grid maxWidth="md">
          <Row>
            ...
            >
              <Box mt={{ xs: 8, md: 12 }}>
                <Box mb={1}>
                  <Text font={Text.Font.Title} size={Text.Size.Xxl}>
                    Register an account
                  </Text>
                </Box>
                ...
                >
                  ...
                  <Box mb={2}>
                    ...
                    <Box mt={1.25}>
                      <PasswordFeatures
                        hasLowercaseLetter={
                          !!password && validations.password.lowercase
                        }
                        hasUppercaseLetter={
                          !!password && validations.password.uppercase
                        }
                        hasNumber={!!password && validations.password.digit}
                        isMinLength={
                          !!password && validations.password.minLength
                        }
                      />
                    </Box>
                  </Box>
                  ...
                  <Box mt={1}>
                    <Text color={Text.Color.Gray5} size={Text.Size.Xs}>
                      By clicking this button, you agree to Butter&#8217;s{" "}
                      <Link
